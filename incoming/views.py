...
def get_insta_form(request):
    ...
    class InstaForm(forms.Form):
        ...
        m_card_allowed = forms.BooleanField(label='m_card_allowed')
        m_ieft_allowed = forms.BooleanField(label='m_ieft_allowed')
        m_mpass_allowed = forms.BooleanField(label='m_mpass_allowed')
        m_chips_allowed = forms.BooleanField(label='m_chips_allowed')
        m_trident_allowed = forms.BooleanField(label='m_trident_allowed')
        m_payat_allowed = forms.BooleanField(label='m_payat_allowed')
        ...
        m_tx_item_description = forms.CharField(label='m_tx_item_description', max_length=100)
        ...
        m_cancel_url = forms.CharField(label='m_cancel_url', max_length=100)
        m_pending_url = forms.CharField(label='m_pending_url', max_length=100)
        m_notify_url = forms.CharField(label='m_notify_url', max_length=100)
        b_name = forms.CharField(label='b_name', max_length=100)
        b_surname = forms.CharField(label='b_surname', max_length=100)
